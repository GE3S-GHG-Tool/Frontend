...
const StartReportModal = ({ open, setOpenModal }) => {
  ...
  const onSubmit = async () => {
    ...
    if (floorArea.trim()) {
      payload.floor_area = Number(floorArea);
    }
    if (revenue.trim()) {
      payload.revenue = Number(revenue);
    }
    if (totalEmployees.trim()) {
      payload.total_employees = Number(totalEmployees);
    }
    if (totalProduction.trim()) {
      payload.total_production = Number(totalProduction);
    }
        ...
        <div className="report_input_2">
          <div className="report_input">
            ...
            <TextField
              ...
              size="small"
              fullWidth
              placeholder="Add Floor Area (Optional)"
              value={floorArea}
          ...
          <div className="report_input">
            ...
            <TextField
              ...
              size="small"
              fullWidth
              placeholder="Add Revenue (Optional)"
              value={revenue}
        ...
        <div className="report_input_2">
          <div className="report_input">
            ...
            <TextField
              ...
              size="small"
              fullWidth
              placeholder="Add Total Employees (Optional)"
          ...
          <div className="report_input">
            ...
            <TextField
              ...
              size="small"
              fullWidth
              placeholder="Add Total Production (Optional)"
