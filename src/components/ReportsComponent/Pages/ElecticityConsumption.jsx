...
function ElecticityConsumption() {
          ...
          <Grid2 sx={{ display: "flex", flexDirection: "column", gap: "4px" }}>
            ...
            <div>
              <Typography
                ...
                color="#717171"
              >
                Enter the total electricity consumed to estimate indirect
                emissions for Net import from grid.
              </Typography>
            </div>
          </Grid2>
          {/* grid input second */}
...
export default ElecticityConsumption;
