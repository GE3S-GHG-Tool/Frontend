...
const navMenu = [
  {
    segment: '',
    title: 'Dashboard',
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 28 28" fill="none">
      <path d="M3.5 10.472C3.5 4.73055 4.73055 3.5 10.472 3.5H17.528C23.2694 3.5 24.5 4.73055 24.5 10.472V17.528C24.5 23.2694 23.2694 24.5 17.528 24.5H10.472C4.73055 24.5 3.5 23.2694 3.5 17.528V10.472Z" stroke="#717171" stroke-width="2.33333" />
      <path d="M24.5 10.5H3.5" stroke="#717171" stroke-width="2.33333" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M10.5 24.5V10.5" stroke="#717171" stroke-width="2.33333" stroke-linecap="round" stroke-linejoin="round" />
    </svg>,
  },
  {
    segment: 'report',
  ...
  },
  {
    ...
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 28 28" fill="none">
      <g clip-path="url(#clip0_1521_24382)">
        <path d="M6.125 11.375H2.625C2.14175 11.375 1.75 11.7668 1.75 12.25V15.75C1.75 16.2332 2.14175 16.625 2.625 16.625H6.125C6.60825 16.625 7 16.2332 7 15.75V12.25C7 11.7668 6.60825 11.375 6.125 11.375Z" stroke="#717171" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M22.75 4.375H17.5C17.0168 4.375 16.625 4.76675 16.625 5.25V10.5C16.625 10.9832 17.0168 11.375 17.5 11.375H22.75C23.2332 11.375 23.625 10.9832 23.625 10.5V5.25C23.625 4.76675 23.2332 4.375 22.75 4.375Z" stroke="#717171" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M22.75 16.625H17.5C17.0168 16.625 16.625 17.0168 16.625 17.5V22.75C16.625 23.2332 17.0168 23.625 17.5 23.625H22.75C23.2332 23.625 23.625 23.2332 23.625 22.75V17.5C23.625 17.0168 23.2332 16.625 22.75 16.625Z" stroke="#717171" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M7 14H12.25" stroke="#717171" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M16.625 20.125H14C13.5359 20.125 13.0908 19.9406 12.7626 19.6124C12.4344 19.2842 12.25 18.8391 12.25 18.375V9.625C12.25 9.16087 12.4344 8.71575 12.7626 8.38756C13.0908 8.05937 13.5359 7.875 14 7.875H16.625" stroke="#717171" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      </g>
      <defs>
  ...
  },
  {
    segment: 'team-member',
    title: 'Team Member',
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 35 35" fill="none">
      ...
      <Box sx={{ display: 'flex', height: '100vh' }}>
        ...
        >
          <div style={{
            ...
            <div>
              <img src={logo} alt="" width={156} style={{ padding: '12px', margin: '0 auto', display: 'flex' }} />
              <p style={{ border: '2px solid  #F26D58', width: '74%', margin: '4px auto', textAlign: 'center', display: "flex", gap: '5px', fontSize: '0.7rem', alignItems: "center", justifyContent: 'center', height: '1.8rem', padding: '10px 4px', borderRadius: '37px', fontWeight: '500' }}>
                ...
                <span style={{ fontWeight: '500', fontStyle: 'Inter' }}>CarbonZero Plan</span>
              </p>
            </div>
            {/* navMenu Items */}
                  ...
                  {item.kind === "divider" ? (
                    ...
                    <Box
                      sx={{
                        ...
                        fontWeight: location.pathname === `/${item.segment}` ? '700' : 'inherit',
                        '&:hover': {
                          bgcolor: '#E6F8F2',
                          color: 'black'
                        },
                    ...
                    >
                      <p style={{ color: location.pathname === `/${item.segment}` ? 'black' : '#717171', padding: '0', margin: 0, display:'flex', alignItems:'center' }}>
                        {item.icon}
                      </p>
                      <Typography sx={{
                        marginLeft: '12px',
          ...
          <div style={{
            width: '100%', display: 'flex', flexDirection: 'column', borderRadius: '24px',
            ...
            <div>
              ...
              <div>
                <p style={{ fontSize: '0.8rem', fontWeight: '600', padding: '2px', margin: '0' }}>Upgrade to Carbonzero</p>
                <p style={{ fontSize: '0.55rem', fontWeight: '300', padding: '2px', margin: '0' }}>Reduce emissions, save costs, protect environment.</p>
              </div>
            </div>
            <div style={{ display: 'flex', gap: '0.4rem' }}>
              <p style={{ fontSize: '0.7rem', fontWeight: '300', padding: '0', margin: '0 0' }}>Dismiss</p>
              <p style={{ fontSize: '0.7rem', fontWeight: '400', padding: '0', margin: '0 0' }}>Upgrade Now</p>
            </div>
          </div>
        </Box>
            ...
            currentNavItem !== 'Start Survey'
              ...
              >
                ...
                <Toolbar sx={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '13px', width: '7vw' }}>
                    <Avatar src={avatar} alt="User Img" style={{ width: '1.9rem', height: '1.9rem' }} />
                    <Typography sx={{
                      color: '#000',
                      fontSize: '0.875rem',
                      fontWeight: '500'
