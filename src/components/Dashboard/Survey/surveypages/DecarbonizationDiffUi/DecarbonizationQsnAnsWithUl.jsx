...
function DecarbonizationQsnAnsWithUl({ answer }) {
  // console.log("from 8", answer.answer === "No");
  return (
    <div>
      <Grid2
        sx={{
        ...
        >
          ...
          >
            ...
            <Typography fontSize="16px" fontWeight="600" color="#000">
              Energy Conservation Techniques and Thermal Insulation (Applicable
              for both Air-conditioned and Non-Air-Conditioned buildings)
            </Typography>
              ...
              >
                ...
                >
                  <Typography fontSize="0.85rem" fontWeight="400">
                    1. Make Sure that the development team considers the
                    improvement in the energy efficiency of the building&apos;s
                    envelope.
                    <br />
                    <br />
                  ...
                  <Typography fontSize="0.85rem" fontWeight="400">
                    Rest other buildings in the industries, e.g. Admin and
                    office building shall adhere to mandatory
                    <br />
