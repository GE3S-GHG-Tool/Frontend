        ...
        >
            ...
            <div style={{
                ...
                {!getStarted ? <>
                    <button onClick={handleGetStarted} style={StyledButton}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                            <g clip-path="url(#clip0_1850_19597)">
                                <path d="M3.62695 10H17.377" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M11.752 4.375L17.377 10L11.752 15.625" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </g>
                            <defs>
                    ...
                    <hr style={{ color: 'rgba(217, 217, 217, 0.40)', width: '16vw', border: "1px solid rgba(217, 217, 217, 0.40)" }} />
                </> :
                    <button
                        style={StyledButton}
                        // onClick={onAction}
...

                {
                    !getStarted &&
                    <div>
                        <Typography style={{ marginBottom: '12px', fontSize: '0.8rem', fontWeight: '400' }}>
                            Unlock
                        </Typography>
                        <p style={{ padding: 0, margin: "0", textAlign: "center", alignItems: "center", display: "flex", gap: "6px", fontSize: '0.6rem' }}>
