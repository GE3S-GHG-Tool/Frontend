...
// const PersonalInfo = () => {
//   const { fullname, setFullname, imageUrl, setImageUrl } = useSignup();
...
//     e.preventDefault();
//     if (isFormValid) {
//       console.log("Submitting with:", { fullname, imageUrl });
...
//     const isProfileSet = imageUrl?.length > 0;
...
//           <button type="submit" disabled={!isFormValid} className="ge3s_button">
//             Create Account
//           </button>
//         </form>
//         <div
...
const PersonalInfo = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (isFormValid) {
      console.log("Submitting with:", { fullname, imageFile: selectedFile });
      setFullname(fullname);
