...
class MultiPageGHGReportGenerator {
    ...
    sectionPagetwo(user) {
        ...
        this.pdf.setFont('helvetica', 'normal')
        this.pdf.setTextColor("#000");
        this.pdf.text("UAE, KSA, USA, India, Canada",
            this.margins.left,
            this.margins.top + 265
        );
        this.pdf.setFont('helvetica', 'normal')
        this.pdf.setTextColor("#000");
        this.pdf.text("ge3s.org",
            this.margins.left,
        ...
        this.pdf.setFont('helvetica', 'normal')
        this.pdf.setTextColor("#000");
        this.pdf.text("Praveen Kumar Diwakar",
            this.margins.left + 245,
            this.margins.top + 250
        );
        this.pdf.setFont('helvetica', 'normal')
        this.pdf.setTextColor("#000");
        this.pdf.text("Analyst, GE3S",
            this.margins.left + 245,
            this.margins.top + 265
        );
        ...
        this.pdf.setTextColor('#029366');
        this.pdf.setFont('MontserratBold');
        this.pdf.text("Carbon and sustainability expert",
            this.margins.left,
        ...
        this.pdf.setFont('helvetica', 'normal')
        this.pdf.setTextColor("#000");
        this.pdf.text("Satyapal Singh",
            this.margins.left,
            this.margins.top + 350
        );
        this.pdf.setFont('helvetica', 'normal')
        this.pdf.setTextColor("#000");
        this.pdf.text("CEO, GE3S",
            this.margins.left,
        ...
        this.pdf.setFont('helvetica', 'normal')
        this.pdf.setTextColor("#000");
        this.pdf.text("Chilamburaj Anbarasu",
            this.margins.left+ 245,
            this.margins.top + 350
        );
        this.pdf.setFont('helvetica', 'normal')
        this.pdf.setTextColor("#000");
        this.pdf.text("Director, GE3S",
            this.margins.left+ 245,
            this.margins.top + 365
        );
        ...
        this.pdf.setTextColor('#029366');
        this.pdf.setFont('MontserratBold');
        this.pdf.text("Contact",
            this.margins.left,
            this.margins.top + 435
        );

        this.pdf.setFontSize(11);
        this.pdf.setFont('helvetica', 'normal')
        this.pdf.setTextColor("#000");
        this.pdf.text("sustainabilty@ge3s.me",
            this.margins.left,
