...
import Lock from "../../../assets/images/scopelock.svg"
import { Button } from '@mui/material';
import SubscriptionModal from '../../Dashboard/SubscriptionPlans/SubscriptionModal';

export const PremiumContentWrapper = ({ isPremium = false, children, title, desc, reportid }) => {
  ...
  return (
    <>
      ...
      <SubscriptionModal
        ...
        redirectUrl={`checkout-success-from-report/${reportid}`}
      />
    </>
  );
};
